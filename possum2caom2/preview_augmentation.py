...
class PossumPreview(PreviewVisitor):
    ...
    def generate_plots(self, obs_id):
        ...
        self._array_to_jpeg(data, self._storage_name.prev, downscale_factor=2)
        count += 1
        self.add_preview(self._storage_name.prev_uri, self._storage_name.prev, ProductType.PREVIEW)
        self._array_to_jpeg(data, self._storage_name.thumb, downscale_factor=8)
        count += 1
